...
struct ListCertificatesCommand: CommonParsableCommand {
    ...
    @Option(help: "The type of certificate to create. Values: \(ListCertificatesV1.Filter.CertificateType.allValueStringsFormatted)")
...
extension ListCertificatesV1.Filter.CertificateType: ExpressibleByArgument {
