...
struct APIKeyID: EnvironmentLoadableArgument {
    ...
    enum Error: Swift.Error, CustomStringConvertible, Equatable {
        ...
        var description: String {
            ...
            case .apiKeyNotFound:
                ...
                It can be provided either by using the environment variable APP_STORE_CONNECT_API_KEY
    ...
    static let apiKeyEnvironmentKey = "APP_STORE_CONNECT_API_KEY"
    ...
    func loadPEM() throws -> String {
        ...
        guard let apiKeyFileContent =
                try (ProcessInfo.processInfo.environment["APP_STORE_CONNECT_API_KEY"] ??
